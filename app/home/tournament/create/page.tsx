...
import { Trophy, Calendar, DollarSign, FileText, ArrowLeft, Loader2, Users } from "lucide-react"
                ...
                <div className="rounded-xl p-5 space-y-4" style={{ background: "rgba(28,16,42,0.6)", border: "1px solid rgba(255,255,255,0.08)" }}>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value={form.registration_deadline} onChange={handleChange}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input
                                name="tournament_start" type="datetime-local"
                        ...
                        <div>
                            ...
                            <input
                                name="tournament_end" type="datetime-local"
